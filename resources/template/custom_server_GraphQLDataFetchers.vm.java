...
#foreach ($dataFetcher in $dataFetchersDelegate.dataFetchers)
	...
	public DataFetcher<CompletableFuture<#if(${dataFetcher.dataFetcherDelegate.type.requestType}=="subscription")Publisher<#end${dataFetcher.field.javaType}#if(${dataFetcher.dataFetcherDelegate.type.requestType}=="subscription")>#end>> ${dataFetchersDelegate.camelCaseName}${dataFetcher.pascalCaseName}#if(${dataFetcher.completableFuture})WithDataLoader#end() {
		return dataFetchingEnvironment -> {
			Map<String, String> contextMap = MDC.getCopyOfContextMap();
			SecurityContext securityContext = SecurityContextHolder.getContext();
			Executor delegatedExecutor = Executors.newSingleThreadExecutor();
